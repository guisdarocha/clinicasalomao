  ...
  return (
    <Fragment>
        ...
        <div className='col-span-3 flex justify-center pt-[4rem] pb-[8rem]'>
                    <button className='flex bg-gradient-to-r from-whats-escuro via-whats to-whats-escuro border-4 border-branco drop-shadow-lg cursor-pointer px-[4rem] pt-[2rem] pb-[1rem] rounded-[8rem] hover:shadow-dentro hover:shadow-creme '>
                        ...
                        <img src={whats} alt="" className='pl-[1rem] self-end mx-auto'/>
                    </button>
            </div>
      </div>
