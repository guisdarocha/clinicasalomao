    ...
    <Fragment>
        ...
        <div className="max-w-[700px]  bg-creme-claro grid-cols-2 justify-center mx-auto items-center">
            ...
            <Accordion className="bg-vermelho-madeira mt-[2rem]" open={open === 2} icon={<Icon id={2} open={open}  />}>
              <AccordionHeader className="text-[1.9rem] pl-[2rem]  text-creme-claro font-extrabold font-mont  hover:text-creme-claro" onClick={() => handleOpen(2)}>
            ...
            <Accordion className="bg-vermelho-madeira mt-[2rem]" open={open === 3} icon={<Icon id={3} open={open}  />}>
              <AccordionHeader className="text-[1.9rem] pl-[2rem] text-creme-claro font-extrabold font-mont hover:text-creme-claro" onClick={() => handleOpen(3)}>
            ...
            <Accordion className="bg-vermelho-madeira mt-[2rem]" open={open === 4} icon={<Icon id={4} open={open}  />}>
              <AccordionHeader className="text-[2rem] pl-[2rem] text-creme-claro font-extrabold font-mont hover:text-creme-claro" onClick={() => handleOpen(4)}>
            ...
            <Accordion className="bg-vermelho-madeira mt-[2rem]" open={open === 5} icon={<Icon id={5} open={open}  />}>
              <AccordionHeader className="text-[2rem] pl-[2rem] text-creme-claro font-extrabold font-mont  hover:text-creme-claro" onClick={() => handleOpen(5)}>
              Tem contraindicação?
              </AccordionHeader>
              <AccordionBody className="bg-creme text-[1.5rem] py-[2rem] px-[2rem] text-vermelho-madeira font-mont font-semibold leading-tight">
            ...
            <Accordion className="bg-vermelho-madeira mt-[2rem]" open={open === 6} icon={<Icon id={6} open={open}  />}>
              <AccordionHeader className="text-[2rem] pl-[2rem] text-creme-claro font-extrabold font-mont  hover:text-creme-claro" onClick={() => handleOpen(6)}>
            ...
            <Accordion className="bg-vermelho-madeira mt-[2rem] " open={open === 7} icon={<Icon id={7} open={open}  />}>
              <AccordionHeader className="text-[2rem] pl-[2rem] text-creme-claro font-extrabold font-mont  hover:text-creme-claro" onClick={() => handleOpen(7)}>
        ...
        <div className='col-span-3 flex justify-center pt-[4rem] pb-[4rem]'>
          ...
          <a href='https://wa.me/5511997173432?text=Gostaria de saber mais sobre a Estética Salomão'>
                    ...
                    <button className='flex  justify-center items-center mx-auto bg-gradient-to-r from-whats-escuro via-whats to-whats-escuro border-4 border-branco drop-shadow-lg cursor-pointer px-[4rem] pt-[1rem] pb-[1rem] rounded-[8rem] hover:shadow-dentro hover:shadow-creme hover:transition-all hover:ease-out hover:duration-700'>
                      <span className='text-[2rem] font-mont w-[46rem] font-extrabold drop-shadow-lg text-branco leading-tight uppercase hover:text-[2.1rem] hover:w-[49rem] hover:transition-all hover:ease-out hover:duration-700'>Quero iniciar agora meu tratamento</span>
