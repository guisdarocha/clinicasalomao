...
const AcordeaoSection = ({section, isActiveSection, sectionIndex, setActiveIndex} : AcordeaoSectionProps) => {
    ...
    return (
        <div className='mt-[3rem] pt-[1.5rem] -my-[3rem]'>
            ...
            {isActiveSection && <div className='relative mt-[0.1rem] bg-creme flex mx-auto px-[1rem] py-[1rem] drop-shadow-xl font-mont font-medium rounded-xl text-vermelho-madeira leading-tight text-[0.8rem] transition-all ease-out duration-700'>{section.text}</div>}
        </div>
    );
};
