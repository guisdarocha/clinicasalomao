...
const Header = () => {
    return (
    <>
    <div className='bg-gradient-to-t from-creme-escuro to-creme w-full h-[1780px] xl:w-auto md:bg-creme  sm:bg-creme '>
        ...
        <div className="flex justify-center -mt-[3rem]">
            ...
            <div className="flex place-content-end">
                <img src={imagemHeader} alt="" className='w-[744px] h-auto xl:w-[800px] ' />
            </div>
       </div>
        
        <div className="flex -mt-[5rem] xl:-mt-[18rem] md:-mt-[18rem] xl:w-[1280px] xl:flex 2xl:flex 2xl:">
