    ...
    <div className=" bg-laranja flex justify-center items-center mx-auto h-[1200px]">
        ...
        <div className="grid grid-cols-1 pt-[6rem] max-w-[1080px]">
            ...
            <div className='justify-center gap-3 items-center mx-auto pt-[2rem] '>
                <div className='flex justify-center text-center items-center max-w-[55rem]  px-[4rem] py-[1rem] rounded-tl-46 rounded-br-46 bg-vermelho-madeira'>
                    <h5 className='text-[1.8rem] w-[29rem] font-mont text-creme'>PREVENTIVAMENTE, e dê um breque no seu envelhecimento</h5>
                </div>
                <div className='flex justify-center text-center items-center mt-[2rem] max-w-[48rem] px-[4rem] py-[1rem] rounded-tl-46 rounded-br-46 bg-vermelho-madeira'>
                    <h5 className='text-[1.8rem] w-[29rem] font-mont text-creme'>Corretivamente, e rejuvenesça muitos anos</h5>
                </div>
                <div className='flex justify-center text-center items-center mt-[2rem] max-w-[48rem] px-[4rem] py-[1rem] rounded-tl-46 rounded-br-46 bg-vermelho-madeira'>
                    <h5 className='text-[1.8rem] w-[29rem] font-mont text-creme' >Mesmo nunca tendo feito nada</h5>
                </div>
                <div className='flex justify-center text-center items-centermt-[2rem] mt-[2rem] max-w-[48rem] px-[4rem] py-[1rem] rounded-tl-46 rounded-br-46 bg-vermelho-madeira'>
                    <h5 className='text-[1.8rem] w-[29rem] font-mont text-creme' >Independente da sua idade</h5>
                </div>
            </div>
